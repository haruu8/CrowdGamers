# Generated by Django 3.1.5 on 2021-03-09 06:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', models.ImageField(blank=True, default='default/profile_header.jpg', upload_to=teams.models.team.user_directory_path, validators=[teams.models.team.Team.validate_icon_image])),
                ('icon', models.ImageField(blank=True, default='default/profile_icon.png', upload_to=teams.models.team.user_directory_path, validators=[teams.models.team.Team.validate_icon_image])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('from_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='send_member_approval', to=settings.AUTH_USER_MODEL)),
                ('to_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recieve_member_approval', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='send_invitations', to=settings.AUTH_USER_MODEL)),
                ('to_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='receive_invitations', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '招待',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.CharField(max_length=255, verbose_name='志望理由')),
                ('invite_url', models.URLField(blank=True, max_length=255, null=True, verbose_name='招待URL')),
                ('has_read', models.BooleanField(default=False, verbose_name='既読')),
                ('is_proceeded', models.BooleanField(null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('desired_job', models.ManyToManyField(related_name='apply_desired_job', to='teams.Job')),
                ('from_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='send_apply', to=settings.AUTH_USER_MODEL)),
                ('to_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='receive_apply', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'リクエスト',
