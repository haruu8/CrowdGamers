...
class TeamAnonymousUserStatusCodeTests(TestCase):
    ...
    *** : urls に登録してる name
    ...
    def test_notification_team_owner_status_code_anonymous_user(self):
        """
    ...
    def test_notification_team_member_status_code_anonymous_user(self):
        """
    ...
    def test_notification_independent_user_status_code_anonymous_user(self):
        """
