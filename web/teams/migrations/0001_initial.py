# Generated by Django 3.1.5 on 2021-04-14 06:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('teamname', accounts.fields.LowerCharField(db_index=True, max_length=15, unique=True, validators=[django.core.validators.MinLengthValidator(4), django.core.validators.RegexValidator(regex='[a-xA-Z0-9_]')], verbose_name='チームネーム')),
                ('name', models.CharField(max_length=20)),
                ('icon', models.ImageField(blank=True, default='default/profile_icon.svg', upload_to=teams.utils.model_validation.team_directory_path, validators=[teams.utils.model_validation.validate_icon_image])),
                ('header', models.ImageField(blank=True, default='default/profile_header.jpg', upload_to=teams.utils.model_validation.team_directory_path, validators=[teams.utils.model_validation.validate_header_image])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(default='ニックネーム', max_length=20, verbose_name='ニックネーム')),
                ('icon', models.ImageField(blank=True, default='default/profile_icon.svg', upload_to=teams.utils.model_validation.user_directory_path, validators=[teams.utils.model_validation.validate_icon_image])),
                ...
                ('team', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='belonging_user_profiles', to='teams.team')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invitation_url', models.URLField(null=True, verbose_name='招待URL')),
                ('message', models.CharField(max_length=255)),
                ('sender_has_read', models.BooleanField(default=False, verbose_name='from_user の既読')),
                ('reciever_has_read', models.BooleanField(default=False, verbose_name='to_user の既読')),
                ('is_proceeded', models.BooleanField(null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('desired_game_title', models.ManyToManyField(related_name='invitation_desired_game_title', to='teams.Game')),
                ('desired_job', models.ManyToManyField(related_name='invitation_desired_job', to='teams.Job')),
